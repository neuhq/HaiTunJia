...
-(CAAnimationGroup*)animationGroupForward:(BOOL)_forward {
  ...
  t2.m41= t1.m41;
  t2 = CATransform3DTranslate(t2, 0, [self parentTarget].frame.size.height*-0.006, 0);
...
//    [AppContext sharedInstance].unitView.locationUnitCell = nil;
//    [AppContext sharedInstance].unitView.priceUnitCell = nil;
//    [AppContext sharedInstance].unitView.brandUnitCell = nil;
    // Begin overlay animation
