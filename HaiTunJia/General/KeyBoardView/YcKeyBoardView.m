...
-(void)initTextView:(CGRect)frame
{
    ...
    self.textView.layer.borderColor = [[UIColor colorWithHexString:@"c9c9ee"] CGColor];
...
-(void)textViewDidChange:(UITextView *)textView
{
    ...
    CGSize contentSize=[content sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:20.0]}];
